$.fn.myTable = function(options) 
{
	...
	var settings = $.extend({
		buttons: [
			{text: "<i class='fa fa-refresh'></i>&nbsp; Refresh", action: function ( e, dt, node, config ) {dt.ajax.reload()} }, 
			{extend: "print", text: "<i class='fa fa-print'></i>&nbsp; Print", exportOptions: { columns: ':visible'}}, 
			{extend: "excelHtml5", text: "<i class='fa fa-save'></i>&nbsp; Excel", exportOptions: { columns: ':visible'}}, 
			{extend: "colvis", text: "<i class='fa fa-th'></i>&nbsp; Kolom"},
		],
