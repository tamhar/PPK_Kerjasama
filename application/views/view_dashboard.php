...
<div class="panel panel-default">
	<div class="flex-container"> 
		<div class="main-box">
			...
			<div class="bottom">
				<a href="<?php echo site_url('c_data_kerjasama/index') ?>"><p><b>Lihat detail</b></p></a>
			</div>
		</div>
		...
		<div class="main-box">
			...
			<div class="bottom">
				<a href="<?php echo site_url('c_data_kerjasama/index') ?>" style="color:#D9001B;"><p><b>Lihat detail</b></p></a>
			</div>
		</div>
	</div>
